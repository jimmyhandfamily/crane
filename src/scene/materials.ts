...
export function createSharedMaterials() {
  return {
    ...
    oilStain: makeMat("matOilStain", Palette.oilStain, { roughness: 0.55, metalness: 0.12 }),
    ...
    coneStripe: makeMat("matConeStripe", Palette.coneStripe, { roughness: 0.7 }),
    ...
    gravelEdge: makeMat("matGravelEdge", Palette.gravelEdge, { roughness: 0.96 }),
